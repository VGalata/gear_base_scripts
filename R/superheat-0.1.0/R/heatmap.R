generate_heat <- function(X,
                          ...
                          legend.width = 1.5,
                          legend.text.size = 12,
                          legend.title='', # Valentina Galata, 2017.04.06
  ...
  # Valentina Galata, 2017.05.11, BEGIN
  ...
  # Valentina Galata, 2017.05.11, END
  ...
  if (is.null(heat.pal.values) & is.null(legend.breaks)) { # Valentina Galata, 2017,05.11
  ...
  gg.legend <- ggplot2::ggplot(X.df) +
    ...
    ggplot2::scale_fill_gradientn(values = heat.pal.values,
                                  colours = heat.pal,
                                  name = legend.title, # Valentina Galata, 2017.04.06
                                  breaks = breaks,
