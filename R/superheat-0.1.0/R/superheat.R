...
superheat <- function(X,
                      ...
                      linkage.method = c("average", "single", "complete", "ward.D", "ward.D2", "mcquitty", "median", "centroid"), # added on 2018.02.05
                      ...
                      legend.text.size = 12,
                      legend.title = '',
                      legend.breaks = NULL, # Valentina Galata, 2017.05.11
  ...
  linkage.method <- match.arg(linkage.method) # added on 2018.02.05
  ...
  if (pretty.order.cols) {
    hclust.cols <- hclust(dist(t(X), method = dist.method), method=linkage.method) # added linkage.method 2018.02.05
  }

  if (pretty.order.rows) {
    hclust.rows <- hclust(dist(X, method = dist.method), method=linkage.method) # added linkage.method 2018.02.05
  }
